...
wget https://github.com/Vidachain/VIDA-MultiMN/releases/download/v1.0.0/vida-1.0.0-Ubuntu18.04-daemon.tar.gz
tar -xzvf vida-1.0.0-Ubuntu18.04-daemon.tar.gz
